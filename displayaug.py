...
class DisplayAug:
    ...
    def readImage(self, img):
        ...
        imgd= cv.imread(img)
        self.Img = np.array(imgd)
        self.curImg = np.array(imgd)
    ...
    def displayAug(self):
        ...
        cv.imwrite('C://Users//rajes//OneDrive//Desktop//Brain-Tumor-Detection-segmentation//static//img//augment.png',tumorImage)